...
export default function Footer() {
  return (
    <footer className="bg-[#0a2318] text-green-50 pt-16 pb-8 border-t border-white/5">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Brand Info */}
          <div className="space-y-4">
            <Link to="/" className="flex items-center space-x-3 text-white mb-6 group">
              <div className="bg-green-500/10 rounded-full p-1 overflow-hidden h-14 w-14 flex items-center justify-center border border-green-500/20 shadow-sm backdrop-blur-sm">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="text-green-200 hover:text-white transition-colors text-sm">Fresh Milk</Link></li>
              <li><Link to="/" className="text-green-200 hover:text-white transition-colors text-sm">Pure Ghee</Link></li>
              <li><Link to="/" className="text-green-200 hover:text-white transition-colors text-sm">Farm Curd</Link></li>
              <li><Link to="/" className="text-green-200 hover:text-white transition-colors text-sm">Soft Paneer</Link></li>
              <li><Link to="/" className="text-green-200 hover:text-white transition-colors text-sm">White Butter</Link></li>
              <li><Link to="/" className="text-green-200 hover:text-white transition-colors text-sm">Animal Feed</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center space-x-3 text-sm text-green-200">
                ...
                <span>mishradairyfarm4@gmail.com</span>
              </li>
            </ul>
            <div className="mt-8">
              <a 
                ...
                className="inline-flex items-center justify-center bg-[#25D366] hover:bg-[#128C7E] text-white h-14 w-14 rounded-full shadow-lg transition-all transform hover:-translate-y-1 hover:scale-110"
